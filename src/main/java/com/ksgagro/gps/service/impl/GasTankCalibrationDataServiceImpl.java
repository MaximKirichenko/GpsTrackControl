...
//		System.out.print("\nInput " + data);
		...
		if(previous.getData()==next.getData()) return 0.0;
...
//		if(previous.getData()==0) return 0.0;
	...
	@Override
	public Map<Integer, Map<Integer, GasTankCalibrationData>> getCalibrationTables(List<Integer> terminalNumbers,
			long millisFrom) {
		List<GasTankCalibrationData> tables =  calibrationDataRepository.getTables(terminalNumbers, millisFrom);
		return null;
	}
